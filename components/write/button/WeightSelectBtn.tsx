...
export default function WeightSelectButton({ selectedV, isShort }: Props) {
  ...
  return (
    <div className={`flex flex-col items-center justify-center relative ${isShort ? "pb-5" : "pb-10"}`}>
      ...
      <button
        ...
        className={`${
          selectedV.length !== 0 ? "bg-button-fill-brand-default " : "bg-button-fill-disabled-primary "
